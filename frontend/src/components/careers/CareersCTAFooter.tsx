...
const checks = [
  "Free to get started",
  "Built around your personality",
  "Career matches you'll actually love",
];
              ...
              <div className="relative z-10 grid items-center gap-10 lg:grid-cols-2">
                ...
                <div className="order-1 space-y-6 lg:order-2">
                  <div className="inline-flex items-center gap-2 rounded-full bg-primary/10 px-3 py-1.5 text-xs font-semibold text-primary">
                    <Sparkles className="size-3.5" /> Find your fit
                  </div>
                  ...
                  <p className="max-w-md text-sm leading-relaxed text-muted">
                    Let Novi find it. Explore thousands of careers and unlock
                    the ones that truly match your interests, strengths and
                    goals.
                  </p>
